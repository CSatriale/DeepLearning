...
volume_1 = Conv2D(64, (3,3), padding='same', activation='relu')(volume_1)
...
hist = model.fit(X_train, y_train, validation_data=(X_test, y_test), epochs=epochs, batch_size=1024)
